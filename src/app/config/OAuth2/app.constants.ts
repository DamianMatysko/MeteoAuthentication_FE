export class AppConstants {
  // private static API_BASE_URL = 'http://localhost:9090/';
  private static API_BASE_URL = 'https://meteoauth.tk/';
  private static OAUTH2_URL = AppConstants.API_BASE_URL + 'oauth2/authorization/';
  // private static REDIRECT_URL = '?redirect_uri=http://localhost:4200/login';
  // private static REDIRECT_URL = '?redirect_uri=http://localhost:9090/login';
  private static REDIRECT_URL = '?redirect_uri=https://meteoauth.tk/';
